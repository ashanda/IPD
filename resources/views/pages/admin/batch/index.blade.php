				...
				<div class="page-header">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-12 text-right">
							<div class="dropdown">
								<button type="submit" class="btn btn-primary dropdown-toggle no-arrow">Add Batch</button>
							</div>
						</div>
							...
							<tr>
								...
								<td>
									<div class="row">
										...
										<div class="col">
											<form  id="delete-form-{{ $batch->id }}" action="{{ route('batch.destroy', $batch->id) }}" method="POST">
												@csrf
												@method('DELETE')
