			...
			<div class="page-header">
				<form action="{{ route('verbal-exam.store') }}" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<div class="custom-file">
									<input type="file" class="custom-file-input" name="document" id="cover" onchange="updateLabel()">
					...
					<div class="col-md-3 col-sm-12 text-right">
						<div class="dropdown">
							<button type="submit" class="btn btn-primary dropdown-toggle no-arrow">Add Verbal Exam</button>
						</div>
					</div>
						...
						<td class="table-plus">
							...
							@foreach($batch->bid as $item)
									...
									<div class="row">
										...
										<div class="col">
											<form id="delete-form-{{ $batch->id }}" action="{{ route('verbal-exam.destroy', $batch->id) }}" method="POST">
												@csrf
												@method('DELETE')
