...
<div class="main-container">
	<div class="pd-ltr-20 xs-pd-20-10">
		<div class="min-height-200px">
			...
			<div class="page-header">
				<form action="{{ route('notice.update',$findData->id) }}" method="POST">
					@csrf
					@method('PUT')
					<div class="row">
						...
						<div class="col-md-12 col-sm-12 mt-20">
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-10">
									...
									<input class="form-control" type="text" name="notice" value="{{ $findData->notice }}" required>
								</div>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-12 mt-20">
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input class="form-control date-picker" name="expire_date" value="{{ $findData->expire_date }}" placeholder="Select Date" type="text" required>
								</div>
							</div>
						</div>
							...
							<tr>
								...
								<td>
									<div class="row">
										...
										<div class="col">
											<form id="delete-form-{{ $notice->id }}" action="{{ route('notice.destroy', $notice->id) }}" method="POST">
												@csrf
												@method('DELETE')
												<button type="button" class="btn btn-link" onclick="showDeleteConfirmation({{ $notice->id }})">
