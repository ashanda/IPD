				...
				<div class="page-header">
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								<button type="submit" class="btn btn-primary dropdown-toggle no-arrow">Update Workshop</button>
							</div>
						</div>
			...
			<div class="card-box mb-30">
				...
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						<thead>
							<tr>
								<th class="table-plus datatable-nosort">Workshop name</th>
								<th>Link</th>
								<th>Publish date</th>
								<th>Start time</th>
								<th>End time</th>
							...
							<tr>
								...
								<td>
									<div class="row">
										...
										<div class="col">
											<form id="delete-form-{{ $batch->id }}" action="{{ route('workshop.destroy', $batch->id) }}" method="POST">
												@csrf
												@method('DELETE')
